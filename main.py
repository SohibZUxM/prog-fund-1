...
service2 = Service('13March2023',Service_Type.Oil_Replacement,1,sohib.getCustomerID,car.getVehicle_ID)
service3 = Service('13March2023',Service_Type.Tire,1,sohib.getCustomerID,car.getVehicle_ID)
...
if __name__ == '__main__':
    ...
    print(1,'',service1.getServiceType().name,'___________________', prices[service1.getServiceType().name])
    print(2,'',service2.getServiceType().name,'_______________', prices[service2.getServiceType().name])
    print(3,'',service3.getServiceType().name,'__________________________', prices[service3.getServiceType().name])
